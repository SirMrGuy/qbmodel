...
tournaments = []
with open('../data/2018-19/tourneys.txt') as f:
    for line in f:
...
for tournament in tournaments:
    ...
    with open('../data/2018-19/tournaments/'+tournament[0]+'.txt') as scores:
        aliases = {}
        try:
            with open('../data/2018-19/aliases/'+tournament[0]+'.txt') as alias:
                for a in alias:
                    lst = a.strip('\n').split(',')
                    aliases[lst[0]] = lst[1]
        except:
